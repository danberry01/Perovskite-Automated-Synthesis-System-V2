...
class LocationEntry(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.location_name = ctk.CTkEntry(master=self, width = 100, placeholder_text="Location Name",corner_radius = 0)
        self.location_name.grid(row=0, column=0,padx=5,pady=5)
        
        self.x_coord = ctk.CTkEntry(master=self, width=50, placeholder_text="X",corner_radius = 0)
        self.x_coord.grid(row=0, column=1,padx=5,pady=5)
        
        self.y_coord = ctk.CTkEntry(master=self,width=50,placeholder_text="Y",corner_radius = 0)
        self.y_coord.grid(row=0, column=2,padx=5,pady=5)
        
        self.z_coord = ctk.CTkEntry(master=self,width=50, placeholder_text="Z",corner_radius = 0)
